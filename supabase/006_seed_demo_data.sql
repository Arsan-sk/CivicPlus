...
-- (CM auth users are seeded securely via node seed_auth.js script to avoid GoTrue metadata corruption)
...
-- (Citizen auth users are seeded securely via node seed_auth.js script to avoid GoTrue metadata corruption)
/*
INSERT INTO auth.users (id, instance_id, email, encrypted_password, email_confirmed_at, created_at, updated_at, raw_app_meta_data, raw_user_meta_data, is_super_admin, role, aud) VALUES
...
('15500000-0000-0000-0000-000000000001', 'f0000000-0000-0000-0001-000000000001', 'Potholes during monsoon on Western Express Highway', 'Large craters formed near the Metro station, causing heavy traffic bottlenecks and multiple minor accidents. #FixOurRoads #MumbaiTraffic', 'e0000000-0000-0000-0000-000000000001', 'critical', 'in_progress', 'c0000000-0000-0000-0000-000000000001', 19.1234, 72.8567, 'Western Express Highway, Andheri East, Mumbai', 'Ward K-East', 'd0000000-0000-0000-0001-000000000001', 'da000000-0000-0000-0000-000000000001'),
('15500000-0000-0000-0000-000000000002', 'f0000000-0000-0000-0001-000000000002', 'Construction Dust at Real Estate Site in Lower Parel', 'A major commercial highrise project is violating green net construction rules, releasing massive dust into the residential area nearby. #StopPollution #CleanAir', 'e0000000-0000-0000-0000-000000000010', 'medium', 'submitted', 'c0000000-0000-0000-0000-000000000001', 18.9950, 72.8250, 'Senapati Bapat Marg, Lower Parel, Mumbai', 'Ward G-South', 'd0000000-0000-0000-0001-000000000004', NULL),
('15500000-0000-0000-0000-000000000003', 'f0000000-0000-0000-0001-000000000003', 'Broken Footpath near Dadar Station', 'The paving stones of the pedestrian sidewalk are broken and caving in, making it extremely unsafe for senior citizens. #SaferStreets #DadarWalkway', 'e0000000-0000-0000-0000-000000000005', 'low', 'resolved_by_authority', 'c0000000-0000-0000-0000-000000000001', 19.0178, 72.8478, 'Station Road, Dadar West, Mumbai', 'Ward G-North', 'd0000000-0000-0000-0001-000000000001', 'da000000-0000-0000-0000-000000000001'),
('15500000-0000-0000-0000-000000000004', 'f0000000-0000-0000-0001-000000000004', 'Bridge maintenance issues at Gokhale Bridge', 'Major cracks visible on the side columns of the bridge. Heavy structural inspection needed immediately before monsoon. #BridgeSafety #AndheriWest', 'e0000000-0000-0000-0000-000000000005', 'critical', 'seen_by_authority', 'c0000000-0000-0000-0000-000000000001', 19.1190, 72.8465, 'Gokhale Bridge, Andheri, Mumbai', 'Ward K-East', 'd0000000-0000-0000-0001-000000000001', NULL),
('15500000-0000-0000-0000-000000000005', 'f0000000-0000-0000-0001-000000000005', 'Garbage Accumulation on Versova Beach', 'Plastic and medical waste accumulated on the shoreline, posing severe threat to marine life and local visitors. #SaveVersovaBeach #CleanOurCoast', 'e0000000-0000-0000-0000-000000000002', 'medium', 'community_verification_pending', 'c0000000-0000-0000-0000-000000000001', 19.1350, 72.7980, 'Versova Beach, Mumbai', 'Ward K-West', 'd0000000-0000-0000-0001-000000000004', NULL);

-- Delhi (3 issues)
INSERT INTO public.issue_reports (id, author_id, title, description, category_id, severity, status, city_id, latitude, longitude, address, ward, assigned_department_id, assigned_authority_id) VALUES
('15500000-0000-0000-0000-000000000006', 'f0000000-0000-0000-0002-000000000001', 'Severe Air Pollution due to Waste Burning in Okhla', 'Regular open burning of industrial plastic and rubber waste during night hours, choking nearby residential colonies. #SaferStreets #OkhlaPollution', 'e0000000-0000-0000-0000-000000000010', 'critical', 'in_progress', 'c0000000-0000-0000-0000-000000000002', 28.5355, 77.2874, 'Okhla Industrial Area Phase III, New Delhi', 'Ward 102S', 'd0000000-0000-0000-0002-000000000004', 'da000000-0000-0000-0000-000000000002'),
('15500000-0000-0000-0000-000000000007', 'f0000000-0000-0000-0002-000000000002', 'Overflowing Garbage Dump near Connaught Place', 'Public trash bins are overflowing for days. The stinking smell has spread across the footpath, blocking pedestrians. #CleanDelhi #CPConnaught', 'e0000000-0000-0000-0000-000000000002', 'medium', 'community_verified', 'c0000000-0000-0000-0000-000000000002', 28.6304, 77.2177, 'Outer Circle, Connaught Place, New Delhi', 'Ward 88N', 'd0000000-0000-0000-0002-000000000004', NULL),
('15500000-0000-0000-0000-000000000008', 'f0000000-0000-0000-0002-000000000003', 'Waterlogging near ITO intersection', 'Flooding of roads even after minor rainfall due to blocked drainage inlets, causing massive traffic delays. #DrainageIssues #ITODelhi', 'e0000000-0000-0000-0000-000000000006', 'high', 'awaiting_community_verification', 'c0000000-0000-0000-0000-000000000002', 28.6272, 77.2438, 'ITO Junction, New Delhi', 'Ward 95E', 'd0000000-0000-0000-0002-000000000005', NULL);

-- Bengaluru (2 issues)
INSERT INTO public.issue_reports (id, author_id, title, description, category_id, severity, status, city_id, latitude, longitude, address, ward, assigned_department_id, assigned_authority_id) VALUES
('15500000-0000-0000-0000-000000000009', 'f0000000-0000-0000-0003-000000000001', 'Extreme Traffic Congestion at Silk Board Junction', 'Due to construction work and faulty light timers, traffic is stuck for hours during peak morning and evening times. #FixSilkBoard #BengaluruTraffic', 'e0000000-0000-0000-0000-000000000008', 'high', 'in_progress', 'c0000000-0000-0000-0000-000000000003', 12.9172, 77.6228, 'Central Silk Board Junction, Hosur Road, Bengaluru', 'Ward 191', 'd0000000-0000-0000-0003-000000000001', 'da000000-0000-0000-0000-000000000004'),
('15500000-0000-0000-0000-000000000010', 'f0000000-0000-0000-0003-000000000002', 'Lake Pollution & Toxic Foam at Bellandur Lake', 'Untreated chemical waste and sewage being discharged directly into the lake, creating massive clouds of white toxic foam. #SaveBellandurLake #BengaluruEco', 'e0000000-0000-0000-0000-000000000010', 'critical', 'community_verified', 'c0000000-0000-0000-0000-000000000003', 12.9304, 77.6784, 'Bellandur Lake Bed, Bengaluru', 'Ward 150', 'd0000000-0000-0000-0003-000000000005', NULL);

-- Chennai (3 issues)
INSERT INTO public.issue_reports (id, author_id, title, description, category_id, severity, status, city_id, latitude, longitude, address, ward, assigned_department_id, assigned_authority_id) VALUES
('15500000-0000-0000-0000-000000000011', 'f0000000-0000-0000-0004-000000000001', 'Waterlogging and Flooding in Velachery', 'Poor storm water drain infrastructure has caused severe flooding and water log in low-lying residential sectors. #VelacheryFloods #ChennaiStorm', 'e0000000-0000-0000-0000-000000000006', 'critical', 'in_progress', 'c0000000-0000-0000-0000-000000000004', 12.9780, 80.2180, 'Velachery Main Road, Chennai', 'Ward 177', 'd0000000-0000-0000-0004-000000000005', 'da000000-0000-0000-0000-000000000003'),
('15500000-0000-0000-0000-000000000012', 'f0000000-0000-0000-0004-000000000002', 'Garbage Dump Accumulation in Pallikaranai Marshland', 'Unmanaged municipal waste dump expanding into the protected eco-sensitive marshland habitat. #SaveMarshlands #ChennaiGreen', 'e0000000-0000-0000-0000-000000000002', 'critical', 'community_verified', 'c0000000-0000-0000-0000-000000000004', 12.9460, 80.2190, 'Pallikaranai Dumping Ground, Chennai', 'Ward 180', 'd0000000-0000-0000-0004-000000000004', NULL),
('15500000-0000-0000-0000-000000000013', 'f0000000-0000-0000-0004-000000000003', 'Severe Road Damage and Potholes in T. Nagar', 'Top surface of the asphalt road completely eroded, leaving large gravel particles and deep potholes exposed. #FixUsmanRoad #ChennaiRoads', 'e0000000-0000-0000-0000-000000000001', 'medium', 'submitted', 'c0000000-0000-0000-0000-000000000004', 13.0400, 80.2330, 'Usman Road, T. Nagar, Chennai', 'Ward 113', 'd0000000-0000-0000-0004-000000000001', NULL);

-- Hyderabad (2 issues)
INSERT INTO public.issue_reports (id, author_id, title, description, category_id, severity, status, city_id, latitude, longitude, address, ward, assigned_department_id, assigned_authority_id) VALUES
('15500000-0000-0000-0000-000000000014', 'f0000000-0000-0000-0005-000000000001', 'Sewage Overflow and Drainage Block in Ameerpet', 'Overflowing sewer manholes flooding the main shopping lanes with dirty water, causing severe stink. #SewageCleanup #Ameerpet', 'e0000000-0000-0000-0000-000000000006', 'high', 'in_progress', 'c0000000-0000-0000-0000-000000000005', 17.4374, 78.4482, 'Ameerpet Cross Roads, Hyderabad', 'Ward 92', 'd0000000-0000-0000-0005-000000000005', 'da000000-0000-0000-0000-000000000005'),
('15500000-0000-0000-0000-000000000015', 'f0000000-0000-0000-0005-000000000002', 'Open Manhole Hazard near Gachibowli IT Corridor', 'Manhole cover missing on the service road. Extremely dangerous for two-wheelers navigating during dark hours. #SaferStreets #GachibowliHazard', 'e0000000-0000-0000-0000-000000000009', 'critical', 'closed', 'c0000000-0000-0000-0000-000000000005', 17.4401, 78.3489, 'Hitec City Road, Gachibowli, Hyderabad', 'Ward 104', 'd0000000-0000-0000-0005-000000000005', NULL);
